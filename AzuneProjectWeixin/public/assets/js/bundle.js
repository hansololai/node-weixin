...
},{"../public/assets/js/backbone.modal.js":34,"./models":6,"./template/general.hbs":7,"./template/keyword.hbs":8,"./template/message.hbs":9,"./template/notification.hbs":10,"./template/popup.hbs":11,"./template/replymaterial.hbs":12,"./template/sidebar.hbs":13,"backbone":14,"hbsfy/runtime":32,"jquery":33,"lodash":2}],5:[function(require,module,exports){
(function (global){
﻿(function(){
	var $ = require('jquery');
    var Backbone = require('backbone');
