...
},{"./View":2,"backbone":14,"jquery":33}],2:[function(require,module,exports){
"use strict";
var $ = require('jquery');
//var Backbone = require('backbone');
...
},{"../public/assets/js/backbone.modal.js":13,"./models":4,"./template/general.hbs":5,"./template/keyword.hbs":6,"./template/message.hbs":7,"./template/modals/reply.hbs":8,"./template/notification.hbs":9,"./template/replymaterial.hbs":10,"./template/sidebar.hbs":11,"hbsfy/runtime":12,"jquery":33,"lodash":34}],3:[function(require,module,exports){
(function (global){
﻿(function(){
	var $ = require('jquery');
    var Backbone = require('backbone');
...
},{"./Router":1,"./View":2,"./models":4,"backbone":14,"handlebars":31,"jquery":33,"lodash":34}],4:[function(require,module,exports){
var Backbone = require('backbone');
$ = require('jquery');
Backbone.$ = $;
Models = {};
...
},{"backbone":14,"jquery":33}],5:[function(require,module,exports){
...
},{"hbsfy/runtime":12}],6:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  var stack1, helper, functionType="function", escapeExpression=this.escapeExpression, buffer = "\n        <tr id=\""
    ...
    + "</td><td>";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 && depth0.RegularReply)),stack1 == null || stack1 === false ? stack1 : stack1.MsgType), {"name":"if","hash":{},"fn":this.program(2, data),"inverse":this.noop,"data":data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</td><td>";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 && depth0.RegularReply)),stack1 == null || stack1 === false ? stack1 : stack1.Title), {"name":"if","hash":{},"fn":this.program(4, data),"inverse":this.noop,"data":data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</td><td>";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 && depth0.MemberReply)),stack1 == null || stack1 === false ? stack1 : stack1.MsgType), {"name":"if","hash":{},"fn":this.program(6, data),"inverse":this.program(8, data),"data":data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</td><td>";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 && depth0.MemberReply)),stack1 == null || stack1 === false ? stack1 : stack1.Title), {"name":"if","hash":{},"fn":this.program(10, data),"inverse":this.program(8, data),"data":data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  return buffer + "</td></tr>\n        ";
...
},{"hbsfy/runtime":12}],8:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
...
},{"hbsfy/runtime":12}],9:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  var helper, functionType="function", escapeExpression=this.escapeExpression;
...
},{"hbsfy/runtime":12}],10:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":12}],11:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template({"compiler":[5,">= 2.0.0"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":12}],12:[function(require,module,exports){
...
},{"backbone":14,"lodash":34}],14:[function(require,module,exports){
//     Backbone.js 1.1.2
